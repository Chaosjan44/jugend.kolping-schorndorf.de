                    ...
                    <form action="fest.php" method="post" class="<?php if (!isMobile()) print('row');?> align-items-center">
                        <div class="col-10">
                            <div class="form-floating mb-2">
                                <input id="inputName" type="text" name="fest_name" placeholder="Fest Name" class="form-control border-0 ps-4 text-dark fw-bold" required autofocus>
                                <label for="inputName" class="text-dark fw-bold">Fest Name</label>
                            </div>
                            <div class="form-floating mt-2">
                                <input id="inputUrl" type="text" name="fest_url" placeholder="Fest URL" class="form-control border-0 ps-4 text-dark fw-bold" required autofocus>
                                <label for="inputUrl" class="text-dark fw-bold">Fest URL</label>
                            </div>
                        </div>
                ...
                <form action="poll.php" method="post" class="<?php if (!isMobile()) print('row');?> align-items-center">
                    <div class="col-8">
                        <div class="form-floating">
                            <input id="inputName" type="text" name="poll_name" placeholder="Fest Name" value="<?=$fest['fest_name']?>" class="form-control border-0 ps-4 text-dark fw-bold" required autofocus>
                            <label for="inputName" class="text-dark fw-bold">Fest Name</label>
                        </div>
                    </div>
