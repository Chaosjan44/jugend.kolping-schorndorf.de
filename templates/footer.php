...
<?php if (!isMobile()): ?>
    <footer class="container-fluid cbg3 py-3">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-4 text-center ctext light"><a href="/internal.php" class="text-center ctext light">&copy; <?=$crdate?> Kolpingjugend Schorndorf</a></div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-6 ctext text-start light ps-0"><a href="/internal.php" class="ctext light">&copy; <?=$crdate?> Kolpingjugend Schorndorf</a></div>
