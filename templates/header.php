...
<nav class="navbar header-header navbar-expand-lg navbar-<?php print(check_style());?> cbg ctext sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="/">
            <img src="/favicon<?php if (check_style() == "dark") { print("_dark"); }?>.svg" class="navbar-icon d-inline-block align-text-top pe-2">
            <?php if (!isMobile()) {print("Kolpingjugend<br>Schorndorf");} else {print("KJ Schorndorf");}?>
        </a>
