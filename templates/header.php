...
<nav class="navbar header-header navbar-expand-lg navbar-<?php print(check_style());?> cbg ctext sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="/">
            <img src="/favicon.svg" style="display: none;" class="navbar-icon_light d-inline-block align-text-bottom pe-2">
            <img src="/favicon_dark.svg" style="display: none;" class="navbar-icon_dark d-inline-block align-text-bottom pe-2">
