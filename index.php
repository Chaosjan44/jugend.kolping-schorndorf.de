...
<div class="container-fluid px-0 pt-0 pb-3">
    ...
    <div class="container-xxl">
        <div class="row ctext">
            ...
            <span class="text-center text-size-large">Die Kolpingjugend Schorndorf ist eine Gruppierung der <a href="https://kolping-schorndorf.de/" class="hoverlink ctext">Kolpingsfamilie Schorndorf</a>,<br>wir treffen uns jeden 2. Samstag zu Gruppenstunden</span>
        </div>
        <div class="row gx-5">
